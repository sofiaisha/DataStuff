...
public class MLSample {
	...
	public static void main(String[] args) {
		...
		request.addRecordEntry("age", "32").addRecordEntry("job", "management").addRecordEntry("marital", "married")
		.addRecordEntry("education","university").addRecordEntry("default", "no").addRecordEntry("housing", "yes")
